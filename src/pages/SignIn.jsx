...
const SignIn = props => {
	...
	return (
		<Container
			fluid
			className="main_layout loginGradiant"
			style={{
				width: '100%',
				overflowX: 'hidden',
		...
		>
			<Row style={{ zIndex: '10000', opacity: 1 }}>
				<Col
					...
					style={{ maxWidth: '480px', marginLeft: 'auto', marginRight: 'auto', width: '100%', padding: '60px 0' }}
				>
					<Row>
					...
					<Row>
						<Col lg={12} className="text-center intro-text">
							<span className="text-center">
								Farm <strong style={{ color: '#FF2E59', fontFamily: 'Visby 800' }}>$xKAWA</strong> by staking the most
								popular community tokens such as SHIB, KISHU, AKITA and more!
							</span>
						</Col>
					</Row>
					<Row>
						<Col lg={{ span: 12 }} style={{ padding: 4 }}>
							<div className="p-4 m-4 loginBox" style={{ background: 'white', borderRadius: '12px' }}>
								<Row className="p-4 text-center">
									<Col lg={12}>
										<h3 style={{ letterSpacing: '-0.04em' }}>Connect your wallet to start farming</h3>
									</Col>
									<Col lg={12} className="pt-4">
										<p style={{ color: '#DE4949', fontSize: '14px', lineHeight: '21px' }}>
							...
							<div className="wallet-set-up-link-box mx-4">
								<p className="walletsetup text-center">
